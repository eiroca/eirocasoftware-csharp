...
namespace GlynnTucker.Cache {
  public sealed class SimpleMemoryCache : ICache {
    ...
    internal class CombinedDictionaryEnumerator : IDictionaryEnumerator {
      ...
      public object Key {
        get {
          return keyEnumerator.Key;
        }
      }
      public object Value {
        get {
          return valueEnumerator.Value;
        }
      }
      ...
      public DictionaryEntry Entry {
        get {
          lock (this) {
            return new DictionaryEntry(keyEnumerator.Key, valueEnumerator.Value);
          }
        }
      }
    ...
    public object SyncRoot {
      get {
        return this;/*prototype implementation. TODO: think on this some more.*/
      }
    }
    ...
    public IDictionaryEnumerator GetEnumerator() {
      return new DictionaryEnumeratorJoiner(this, new CombinedDictionaryEnumerator(timedStorageIndex, timedStorage), untimedStorage.GetEnumerator());
    }
